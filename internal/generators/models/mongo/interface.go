...
type Store interface {
	...
	Get{{- title (plural .Name) -}} (ctx context.Context, filters *{{- title .Name -}}Filters, after *string, before *string, first *int64, last *int64, sortBy *string, sortOrder *string) ([]* {{- title .Name}}, bool, bool,string, string, error) 
